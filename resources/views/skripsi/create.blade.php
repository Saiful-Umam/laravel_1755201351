...
@section('content')
   ...
   @csrf
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-5">
        <input type="text" name="nim" class="form-control"id="nim" placeholder="Masukan NIM dengan benar">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
      <textarea name="tempat_penelitian" class="form-control" id="tempat_penelitian"></textarea>      </div>
      </div>
    <div class="form-group row">
